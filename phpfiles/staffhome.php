    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="staffhome.php?disp=class_schedule">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">My Schedule</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="staffhome.php?disp=stud_teach">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">View Students</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="staffhome.php?disp=take_attendance">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Take Attendance</span>
            </a>
          </li>
         <li class="nav-item">
            <a class="nav-link" href="staffhome.php?disp=addmarks">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Add Marks</span>
            </a>
          </li>
         <li class="nav-item">
            <a class="nav-link" href="staffhome.php?disp=list">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Mark List</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="staffhome.php?disp=view_attendance">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Attendance List</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="staffhome.php?log=1">
      ...
      <?php
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="../New folder/student-management-banner-1920x1080-1-1024x576.png" alt="people">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024. <a href="" target="_blank">Emmanuel College</a>. All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Developed by Sangeeth/Abhisek/Sarang <i class="ti-heart text-danger ml-1"></i></span>
          </div>
        </footer>
        <!-- partial -->
      </div>
