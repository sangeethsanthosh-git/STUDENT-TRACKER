...
{
$stud_sql="select * from students where stud_id='$user'";
$res_stud=$con->query($stud_sql);
$s_row=$res_stud->fetch_assoc();
}
include("conn.php");
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="userhome.php?disp=perf&ut=stud">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">My Performance</span>
            </a>
          </li>
         
          <li class="nav-item">
            <a class="nav-link" href="userhome.php?log=1">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome <?php echo  $s_row['name']; ?></h3>
...
while($row=$res->fetch_assoc())
{
	...
	else
	{
		...
		if($p==0 || $alert>0)
		{
          echo '<h4 style="color:#FF0000;">You are not eligible for examination</h4>';
		}
		else
		{
          echo '<h4 style="color:#00CC00;">You are eligible for examination</h4>';
		}
		  ?>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2023. <a href="" target="_blank">Emmanuel College</a>. All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">sangeeth/abhishek/sarang<i class="ti-heart text-danger ml-1"></i></span>
          </div>
        </footer>
        <!-- partial -->
      </div>
